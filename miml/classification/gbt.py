...
class GradientTreeBoost(Classifer):
    ...
    def __init__(self, x=None, y=None, attributes=None, ntrees=500, max_nodes=6, shrinkage=0.05,
    ...
    def _learn(self):
        ...
        self._model = JGradientTreeBoost(self._attributes, self._x.tojarray('double'),
            self._y.tojarray('int'), self._ntrees, self._max_nodes, self._shrinkage, 
            self._sub_sample)
